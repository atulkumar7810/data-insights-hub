...
const ProjectCard = ({ project, index, isHovered, onHover }: ProjectCardProps) => {
  return (
    ...
    >
      <div className={`h-full flex flex-col rounded-2xl overflow-hidden bg-card border border-border transition-all duration-500 ${
        isHovered ? 'shadow-2xl shadow-accent/10 border-accent/30 -translate-y-2' : 'hover:border-border/80'
      }`}>
        ...
        {/* Project Content - flex-1 to fill remaining space */}
